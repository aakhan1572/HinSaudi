...
PGHOST=DATABASES['default']['HOST']
PGPORT=DATABASES['default']['PORT']
PGUSER=DATABASES['default']['USER']
PGPASSWORD=DATABASES['default']['PASSWORD']
PGDATABASE=DATABASES['default']['NAME']
